...
const variants: Record<Variant, string> = {
  // Cream fill on dark — the primary call to action.
  primary:
  ...
  // Champagne-gold fill for high-emphasis luxury moments.
 ...
 * in-page anchors), otherwise a real <button>. One component covers every CTA
 * in the store via the variant / size props.
 */
